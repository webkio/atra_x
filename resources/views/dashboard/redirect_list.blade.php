...
$generateDataTableList = generateDataTableList("redirect_list_general",["DB"=> $DB ]);
$links = showPageLink($DB);

if(isset($_GET['export'])){
    exportTheData("export_data_redirect_general" , $generateDataTableList , @$_GET['export_type']);
}else{
