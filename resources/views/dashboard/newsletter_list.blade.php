...
$generateDataTableList = generateDataTableList("newsletter_list_general",["DB"=> $DB ]);
$links = showPageLink($DB);

if(isset($_GET['export'])){
    exportTheData("export_data_newsletter_general" , $generateDataTableList , @$_GET['export_type']);
}else{
