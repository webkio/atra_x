...
$generateDataTableList = generateDataTableList("form_schema_list_general",["DB"=> $DB]);
$links = showPageLink($DB);

if(isset($_GET['export'])){
    exportTheData("export_data_form_schema_general" , $generateDataTableList , @$_GET['export_type']);
}else{
